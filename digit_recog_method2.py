...
from kivy.graphics import Color, Line, Rectangle, Fbo
...
class PaintWindow(Widget):
    ...
    def save(self):
        self.export_to_png(filename = "digit.png")
...
class PaintApp(App):
    def build(self):
        ...
        predictBtn.bind(on_release=self.save)
    ...
    def save(self, obj):
        ...
        fbo.draw()
        img = Image.frombytes('RGBA', self.painter.size, fbo.pixels)
        img.save('img.png')
